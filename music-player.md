...
```
                        - html 문서의 언어는 영어라 선언했기 때문에 span 태그를 이용해 lang 속성값에 ko(한글)을 주었다.
```html
                         Love Ex Machina
                    </h1>
                    <strong>
        ...
        <li class="music-play-item">
            <img src="http://image.genie.co.kr/Y/IMAGE/IMG_ARTIST/080/660/591/80660591_1560403300605_1_600x600.JPG" 
            alt="올라가" 
            lang="ko"
            class="music-album-cover">
            <div class="music-info">
            ...
            <audio src="./assets/html-practice_13-music-player_assets_music-2.mp3" class="music-audio"></audio>       
        </li>
    </ol>
